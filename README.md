...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `lukadj996`, `BrowserTest`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Browser Test`, `project_description`
...
See the [open issues](https://github.com/lukadj996/BrowserTest/issues) for a full list of proposed features (and known issues).
